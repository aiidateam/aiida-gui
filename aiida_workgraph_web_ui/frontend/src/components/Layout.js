    ...
    <div className="App">
      <div className="sidebar">
        <nav>
          ...
          <li><Link to="/datanode"><FontAwesomeIcon icon={faDatabase} /><span>DataNode</span></Link></li>
          <li><Link to="/groupnode"><FontAwesomeIcon icon={faLayerGroup} /><span>GroupNode</span></Link></li>
